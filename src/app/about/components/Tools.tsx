...
export default function Tools() {
  ...
  return (
    <div className="flex justify-start items-center flex-col mb-5">
      <h2
        ref={ref}
        className={`text-2xl md:text-xl font-normal mb-3 md:tracking-[.3rem] lg:tracking-[.5rem] uppercase text-white transition-all duration-1000 ${
      ...
      <p
        ref={ref}
        className={`text-gray-200 text-center tracking-wider md:px- transition-all duration-1000 ${
        ...
        <span className="text-white font-bold">Google Colab</span> |{" "}
        <span className="text-white font-bold">Laragon</span> |{" "}
        ...
        <span className="text-white font-medium">CapCut</span> |{" "}
        <span className="text-white font-bold">Canva</span> |{" "}
        <span className="text-white font-bold">ChatGPT</span> |{" "}
        <span className="text-white font-bold">Excel</span> |{" "}
        <span className="text-white font-bold">Notion</span> |{" "}
